            ...
            if (isadmin) or (isallow and ismember) or (user.id in SUDO_USERS) or (user.id in DEV_USERS):
                if connection_status := sql.connect(
                    ...
                    send_message(
                        ...
                        f"Successfully connected to *{chat_name}*. Use /connection for see current available commands.",
            ...
            if connection_status := sql.connect(
                ...
                try:
                    ...
                    bot.send_message(
                        ...
                        f"You have connected with *{chat_name}*. Use /connection for see current available commands.",
                        parse_mode="markdown",
                    )
